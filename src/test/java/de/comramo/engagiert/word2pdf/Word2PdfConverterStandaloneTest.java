...
//        String templateFile = "P:\\COMRAMO\\word2pdf\\testDoc-2seitig.docx";
    String templateFile = "P:\\COMRAMO\\word2pdf\\testDoc-5seitig.docx";
...
//        String backgroundFile = "P:\\COMRAMO\\word2pdf\\220901_P1121006_DWiN_Brief mit Logo FWD.docx";
    String backgroundFile = "P:\\COMRAMO\\word2pdf\\220901_P1121006_DWiN_Brief mit Logo FWD_mehrseitig.docx";
//        String backgroundFile = null;
    String outputFolder = "c:/temp";
    HashMap<String, String> valueMapping = new HashMap<>();
    valueMapping.put("myTextFieldTitle1", "foo1");
    valueMapping.put("myTextFieldTitle2", "foo2");
    valueMapping.put("myTextFieldTitle3", "foo3");
    valueMapping.put("myTextFieldTitle4", "foo4");
    valueMapping.put("myTextFieldTitle5", "foo5");
